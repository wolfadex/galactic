...
{
	if (region.aT.ah === region.a4.ah)
	{
		return 'on line ' + region.aT.ah;
	}
	return 'on lines ' + region.aT.ah + ' through ' + region.a4.ah;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a7: fragment, bc: host, bq: path, bs: port_, bv: protocol, bw: query};
	});
...
var $author$project$Main$Card = $elm$core$Basics$identity;
					...
					A2(
						...
						function (shuffledCrew) {
							return _Utils_update(
								game,
								{
									d: A2($elm$core$List$drop, crewToKill, shuffledCrew),
...
var $author$project$Main$Action = $elm$core$Basics$identity;
...
var $author$project$Main$addCard = F2(
	function (card, game) {
		return _Utils_update(
			game,
			{
				E: A2($elm$core$List$cons, card, game.E)
			});
	});
...
var $author$project$Main$discard = function (game) {
	return _Utils_update(
		game,
		{
			E: A2($elm$core$List$drop, 1, game.E),
			au: _Utils_ap(
				A2($elm$core$List$take, 1, game.E),
				game.au)
		});
};
var $author$project$Main$BlueCube = 0;
var $author$project$Main$GreenSphere = 2;
var $author$project$Main$RedPyramid = 1;
var $author$project$Main$exploreRuins = {
	u: _List_fromArray(
		[
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{c: 'You delve deeper into the ruins and the relics.'})),
						seed);
				}),
			bg: 'Leave the Relics'
		},
					...
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{
									p: A2($elm$core$List$cons, 1, game.p),
									c: 'You take the red pyramid back to the ship.'
								})),
						seed);
				}),
			bg: 'Take the Red Pyramid'
		},
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{
									p: A2($elm$core$List$cons, 2, game.p),
									c: 'You take the green sphere back to the ship.'
								})),
						seed);
				}),
			bg: 'Take the Green Sphere'
		},
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{
									p: A2($elm$core$List$cons, 0, game.p),
									c: 'You take the blue cube back to the ship.'
								})),
						seed);
				}),
			bg: 'Take the Blue Cube'
		}
		]),
	x: function (_v0) {
...
var $author$project$Main$exploreStrangePlanet = {
	u: _List_fromArray(
		[
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						A2(
							$author$project$Main$addCard,
							$author$project$Main$exploreRuins,
							$author$project$Main$discard(
								_Utils_update(
									game,
									{c: 'You delve deeper into the ruins.'}))),
						seed);
				}),
			bg: 'Investigate the Ruins'
		},
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{c: 'You leave the planet and contiue on your journey.'})),
						seed);
				}),
			bg: 'Leave Planet'
		}
...
var $author$project$Main$killPercentCrew = F3(
	function (amount, crew, seed) {
		...
		return A2(
			...
			A3(
				...
				A2($elm$random$Random$float, amount.ay, amount.ax),
...
var $author$project$Game$Crew$modifyMoral = F3(
	function (amount, actionAlignment, crew) {
		var modifier = A2($author$project$Game$Crew$alignmentModifier, actionAlignment, crew.aG);
		return _Utils_update(
			crew,
			{
				az: A2(
...
var $author$project$Main$pirateAlignments = _Utils_Tuple2(
	_Utils_Tuple2(15, 2),
	_List_fromArray(
		[
			_Utils_Tuple2(15, 4),
	...
	return A4(
		...
		F3(
			function (name, morale, alignment) {
				return {aG: alignment, az: morale, bk: name};
			}),
		A2(
			$elm$random$Random$map,
			$elm$core$String$join(' '),
...
var $author$project$Main$pirateBattle = {
	u: _List_fromArray(
		[
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{c: 'You jetison the captive pirates.'})),
						seed);
				}),
			bg: 'Toss Them Into Space'
		},
			{
			i: F2(
				function (game, seed) {
					var _v0 = A2(
						...
						A2(
							...
							$author$project$Game$Crew$random(
								{bZ: $author$project$Main$pirateAlignments, cL: 40, cM: 30})),
						seed);
					var newCrewMembers = _v0.a;
					var nextSeed = _v0.b;
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{
									d: _Utils_ap(
										...
										A2(
											...
											game.d)),
									c: 'You offer them a chance to join your crew. '
								})),
						nextSeed);
				}),
			bg: 'Have Them Join You'
		}
		]),
	x: function (_v1) {
...
var $author$project$Main$defaultDeck = _List_fromArray(
	[
		{
		u: _List_fromArray(
			[
				...
				i: F2(
					function (game, seed) {
						var crewSize = $elm$core$List$length(game.d);
						var _v0 = A3(
							$author$project$Main$killPercentCrew,
							{ax: 0.35, ay: 0.25},
							game.d,
							seed);
						var newCrew = _v0.a;
						...
						return _Utils_Tuple2(
							$author$project$Main$discard(
								_Utils_update(
									...
									{
										d: newCrew,
										c: 'You let the virus run its course and you end up losing ' + ($elm$core$String$fromInt(
								...
								_Utils_update(
									game,
									{
										d: A2(
											...
											newCrew),
										c: 'You emphasize that the doctors work on a cure and end up losing ' + ($elm$core$String$fromInt(
											$elm$core$Basics$floor(
												100 - (($elm$core$List$length(newCrew) * 100) / crewSize))) + '% of the crew. There\'s a slight boost to morale.')
									})),
							nextSeed);
					}),
				bg: 'Prioritize a Vaccine'
			},
				{
				i: F2(
					function (game, seed) {
								...
								_Utils_update(
									game,
									{
										d: A2(
											...
											newCrew),
										c: 'You have the sick stictly quarantined, only losing ' + ($elm$core$String$fromInt(
											$elm$core$Basics$floor(
												($elm$core$List$length(newCrew) * 100) / crewSize)) + '% of the crew but also decreasing morale.')
									})),
							nextSeed);
					}),
				bg: 'Quarantine the Infected'
			}
			]),
		x: function (_v3) {
			var crew = _v3.d;
				...
				i: F2(
					function (game, seed) {
						return _Utils_Tuple2(
							A2(
								$author$project$Main$addCard,
								$author$project$Main$pirateBattle,
								$author$project$Main$discard(
									_Utils_update(
										game,
										{c: 'You engage wiht the pirates, but who will come out the victor?'}))),
							seed);
					}),
				bg: 'Challenge the Pirates'
			}
			]),
		x: function (_v4) {
					...
					function (game, seed) {
						return _Utils_Tuple2(
							$author$project$Main$discard(
								_Utils_update(
									game,
									{c: 'You continue on your journey, ignoring the planet.'})),
							seed);
					}),
				bg: 'Pass it By'
			},
				...
				i: F2(
					function (game, seed) {
						return _Utils_Tuple2(
							A2(
								$author$project$Main$addCard,
								$author$project$Main$exploreStrangePlanet,
								$author$project$Main$discard(
									_Utils_update(
										game,
										{c: 'You send a small group downw to the planet.'}))),
							seed);
					}),
				bg: 'Explore The Surface'
			}
			]),
		x: function (_v5) {
					...
					function (game, seed) {
						...
						return hasGreenSphere ? A2(
							...
							A2(
								$elm$random$Random$map,
								function (shuffledCrew) {
									return $author$project$Main$discard(
										_Utils_update(
											game,
											{
												d: A2(
												...
												p: A2(
													...
													game.p),
												c: 'While restocking your ship the Korgallians see the green sphere relic and react in rage, attacking your crew. You manage to make it out of there but lose 2 crew members. You later learn that this device was a weapon built to destroy the Korgallians and they thought you were attempting to kill them.'
											}));
								},
								$elm_community$random_extra$Random$List$shuffle(game.d)),
							seed) : _Utils_Tuple2(
							$author$project$Main$discard(
								_Utils_update(
									game,
									{c: 'You restock the ship and continue on your journey.'})),
							seed);
					}),
				bg: 'Resupply and Continue'
			}
			]),
		x: function (_v9) {
...
var $author$project$Main$firstCard = {
	u: _List_fromArray(
		[
			{
			i: F2(
				function (game, seed) {
					return _Utils_Tuple2(
						$author$project$Main$discard(
							_Utils_update(
								game,
								{c: 'Your journey into the great beyond beigns'})),
						seed);
				}),
			bg: 'Launch'
		}
			...
			switch (_v0.a.$) {
					...
					if (!_v0.b.$) {
						...
						var _v3 = A2(
							...
							A3(
								$elm$random$Random$map2,
								$elm$core$Tuple$pair,
								$elm_community$random_extra$Random$List$shuffle($author$project$Main$defaultDeck),
								A2(
									$elm$random$Random$list,
									428,
									$author$project$Game$Crew$random(
										{bZ: $author$project$Main$initialCrewAlignments, cL: $author$project$Game$Crew$moraleMaximum, cM: 80}))),
							seed);
						var _v4 = _v3.a;
						var deck = _v4.a;
						var crew = _v4.b;
				...
				default:
					if (_v0.b.$ === 1) {
						...
						var _v6 = _v0.b;
						var seed = _v6.a;
						var windowSize = _v6.b;
						var game = _v6.c;
						var _v7 = A2(
							$elm$core$Maybe$withDefault,
							_Utils_Tuple2(game, seed),
							A2(
								$elm$core$Maybe$map,
								function (_v9) {
									var apply = _v9.i;
								...
								A2(
									...
									$elm$core$List$head(game.E))));
						var nextGame = _v7.a;
						var nextSeed = _v7.b;
						return $elm$core$List$isEmpty(nextGame.d) ? _Utils_Tuple2(
...
var $mdgriffith$elm_ui$Internal$Style$classes = {bP: 'a', aD: 'atv', bR: 'ab', bS: 'cx', bT: 'cy', bU: 'acb', bV: 'accx', bW: 'accy', bX: 'acr', aZ: 'al', a_: 'ar', bY: 'at', aE: 'ah', aF: 'av', b$: 's', b3: 'bh', b4: 'b', b7: 'w7', b9: 'bd', ca: 'bdt', an: 'bn', cb: 'bs', ao: 'cpe', cg: 'cp', ch: 'cpx', ci: 'cpy', K: 'c', aq: 'ctr', ar: 'cb', as: 'ccx', L: 'ccy', ag: 'cl', at: 'cr', cl: 'ct', cm: 'cptr', cn: 'ctxt', ct: 'fcs', a6: 'focus-within', cu: 'fs', cv: 'g', aK: 'hbh', aL: 'hc', ba: 'he', aM: 'hf', bb: 'hfp', cx: 'hv', cz: 'ic', cB: 'fr', aw: 'lbl', cD: 'iml', cE: 'imlf', cF: 'imlp', cG: 'implw', cH: 'it', cI: 'i', bi: 'lnk', ab: 'nb', bl: 'notxt', cO: 'ol', cP: 'or', W: 'oq', cU: 'oh', bo: 'pg', bp: 'p', cV: 'ppe', cX: 'ui', A: 'r', cZ: 'sb', c_: 'sbx', c$: 'sby', c0: 'sbt', c2: 'e', c4: 'cap', c5: 'sev', db: 'sk', t: 't', de: 'tc', df: 'w8', dg: 'w2', dh: 'w9', di: 'tj', aB: 'tja', dj: 'tl', dk: 'w3', dl: 'w5', dm: 'w4', dn: 'tr', $7: 'w6', dp: 'w1', dq: 'tun', bF: 'ts', Z: 'clr', dv: 'u', aV: 'wc', bK: 'we', aW: 'wf', bL: 'wfp', aX: 'wrp'};
...
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.K);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.D)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c6.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.c6.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.A) + ('-' + ($elm$core$String$fromInt(pos.cj) + ('-' + ($elm$core$String$fromInt(pos.bJ) + ('-' + $elm$core$String$fromInt(pos.a9)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$elm$core$String$fromFloat(shadow.b5) + 'px'),
					$elm$core$Maybe$Just(
...
var $mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return _List_fromArray(
		[
			...
			A2(
			$mdgriffith$elm_ui$Internal$Model$Style,
			($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + ':focus .focusable, ') + (($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + '.focusable:focus, ') + ('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + ' .focusable-thumb'))),
			A2(
				$elm$core$List$filterMap,
				$elm$core$Basics$identity,
				_List_fromArray(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.cx, $mdgriffith$elm_ui$Internal$Style$classes.Z)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ct, $mdgriffith$elm_ui$Internal$Style$classes.Z)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.aD, $mdgriffith$elm_ui$Internal$Style$classes.Z)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {ap: closing, l: _List_Nil, O: _List_Nil, B: selector};
	});
					...
					case 3:
						...
						return _Utils_update(
							rendered,
							{
								l: A2(
									$elm$core$List$cons,
									{ap: '\n}', l: _List_Nil, O: props, B: '@supports (' + (prop + (':' + (value + (') {' + parent.B))))},
									rendered.l)
							});
					case 5:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.B + ('{' + (renderValues(rule.O) + (rule.ap + '}')));
		}
	};
				...
				case 0:
					...
					return _List_fromArray(
						[
							...
							('.ui-slide-bar:focus + ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.b$) + (' .focusable-thumb' + (selector + '-fs {')))) + (renderedProps + '\n}')
						]);
				default:
					return _List_fromArray(
						[
	...
	function (options, rule, maybePseudo) {
		switch (rule.$) {
			...
			case 9:
				...
				var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.A) + ('-' + ($elm$core$String$fromInt(position.cj) + ('-' + ($elm$core$String$fromInt(position.bJ) + ('-' + $elm$core$String$fromInt(position.a9)))))));
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {a9: height / size, c3: size, bH: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.ce, adjustment.b2, adjustment.co, adjustment.cJ]);
	var lineHeight = 1.5;
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.b$ + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c2))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.L, $mdgriffith$elm_ui$Internal$Style$classes.bX])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.L, $mdgriffith$elm_ui$Internal$Style$classes.bV])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.bW])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.aq, $mdgriffith$elm_ui$Internal$Style$classes.bU])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.bP]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.b4]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.cP]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.cO]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.cB]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.ab, $mdgriffith$elm_ui$Internal$Style$classes.c2, $mdgriffith$elm_ui$Internal$Style$classes.b3]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		...
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.aE + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.a_);
		default:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.b$ + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.K + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.cX, $mdgriffith$elm_ui$Internal$Style$classes.b$, $mdgriffith$elm_ui$Internal$Style$classes.c2]))),
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ag + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.L)),
				A2(
					$elm$core$List$cons,
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.cl + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ag)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Main$PlayCard = function (a) {
	return {$: 1, a: a};
};
		...
		return A4(
			...
			A2(
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.as + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.L + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.c0 + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.bl)))))),
						A2(
							$elm$core$List$cons,
	...
	return $elm$core$String$concat(
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.b5) + 'px',
				$mdgriffith$elm_ui$Internal$Model$floatClass(shadow.c3) + 'px',
				$mdgriffith$elm_ui$Internal$Model$formatColorClass(shadow.ck)
			]));
};
var $mdgriffith$elm_ui$Internal$Flag$shadows = $mdgriffith$elm_ui$Internal$Flag$flag(19);
var $mdgriffith$elm_ui$Element$Border$shadow = function (almostShade) {
	var shade = {b5: almostShade.b5, ck: almostShade.ck, be: false, cN: almostShade.cN, c3: almostShade.c3};
	return A2(
		$mdgriffith$elm_ui$Internal$Model$StyleClass,
...
var $author$project$Main$viewAction = F2(
	function (index, _v0) {
		...
		return A2(
			...
			_List_Nil,
			{
				bg: $mdgriffith$elm_ui$Element$text(action.bg),
	...
	function (attrs, children) {
		...
		if (spaced.$ === 1) {
			return A4(
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.ag + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.L + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aX)))),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
						A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$indexedMap, $author$project$Main$viewAction, card.u))
					])));
	});
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$text(game.c)
						])),
					function () {
					var _v0 = game.E;
					if (!_v0.b) {
						return $mdgriffith$elm_ui$Element$text('deck is empty');
					} else {
						var card = _v0.a;
						return A2($author$project$Main$viewCard, game, card);
					}
				}()
				])));
};
...
var $author$project$Main$viewCrewMember = function (crew) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text(crew.bk),
					$mdgriffith$elm_ui$Element$text(
					...
					[
						...
						if (!_v0.b) {
							...
							return A2(
								...
								A2($elm$core$List$map, $author$project$Main$viewItem, state.p));
						}
					}()
					])),
				A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Main$viewDeck(game)
			]));
};
				...
				$mdgriffith$elm_ui$Element$layoutWith,
				{
					cT: _List_fromArray(
						[
							...
							{
								b1: $elm$core$Maybe$Just($author$project$Gui$Color$focused),
								b8: $elm$core$Maybe$Nothing,
								c1: $elm$core$Maybe$Just(
									{
										b5: 6,
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{cC: $author$project$Main$init, dd: $author$project$Main$subscriptions, dw: $author$project$Main$update, dx: $author$project$Main$view});
